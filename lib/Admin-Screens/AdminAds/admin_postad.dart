...
class AdminPostAD extends StatefulWidget {
  const AdminPostAD({super.key, });

  @override
  State<AdminPostAD> createState() => _AdminPostADState();
}

class _AdminPostADState extends State<AdminPostAD> {
  ...
  Future<void> _saveData() async {
    ...
    try {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => AdminPostsPage()));
    } catch (e) {
